...
final class RealAdapterConfigTests: XCTestCase {
    ...
    func testWixAdapterLocksDownSetupFieldsAndResourceInventory() throws {
        ...
        XCTAssertEqual(items.fileMapping.directory, "items")
        ...
        XCTAssertEqual(projectItems.pull?.url, "https://www.wixapis.com/portfolio/v1/items/query")
        XCTAssertEqual(projectItems.push?.create?.url, "https://www.wixapis.com/portfolio/v1/items")
        XCTAssertEqual(projectItems.push?.update?.url, "https://www.wixapis.com/portfolio/v1/items/{id}")
        XCTAssertEqual(projectItems.push?.delete?.url, "https://www.wixapis.com/portfolio/v1/items/{id}")
    ...
    func testWixAdapterAddsHumanFriendlyOrdersFormsMembersAndSiteProperties() throws {
        ...
        XCTAssertEqual(siteURLs.fileMapping.directory, "site-urls")
    ...
    func testWixAdapterAddsBusinessCatalogResources() throws {
        ...
        XCTAssertEqual(eventRSVPs.fileMapping.directory, "events-rsvps")
        ...
        XCTAssertEqual(eventTickets.fileMapping.directory, "events-tickets")
        ...
        XCTAssertEqual(restaurantMenus.fileMapping.directory, "restaurant-menus")
        ...
        XCTAssertEqual(restaurantReservations.fileMapping.directory, "restaurant-reservations")
        ...
        XCTAssertEqual(restaurantOrders.fileMapping.directory, "restaurant-orders")
